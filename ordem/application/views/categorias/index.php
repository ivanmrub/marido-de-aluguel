    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a title="Cadastrar nova categoria" href="<?php echo base_url('categorias/add'); ?>" class="btn btn-success btn-sm float-right"><i class="fas fa-plus">&nbsp;&nbsp;Novo</i></a>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            <?php foreach ($categorias as $categoria): ?>
                                <tr>
                                    ...
                                    <td class="text-center pr-4"><?php echo ($categoria->categoria_ativa == 1 ? '<span class="badge badge-info  btn-sm">Sim</span>' : '<span class="badge badge-warning btn-sm">Nao</span>' ) ?></td>
                                    <td class="text-right">
                                        ...
                                        <a title="Excluir" href="javascript(void)" data-toggle="modal" data-target="#categoria-<?php echo $categoria->categoria_id; ?>" class="btn btn-sm btn-danger"><i class="far fa-trash-alt"></i></a>
                                    </td>
