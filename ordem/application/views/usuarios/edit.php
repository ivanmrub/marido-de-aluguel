        ...
        <nav aria-label="breadcrumb">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a title="Voltar" href="<?php echo base_url('usuarios');  ?>" class="btn btn-success btn-sm float-right"><i class="fas fa-arrow-left">&nbsp;Voltar</i></a>
            </div>
            <div class="card-body">
                ...
                <form method="POST" name="form_edit">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <label>Ativo</label>
                            <select class="form-control" name="active" <?php echo (!$this->ion_auth->is_admin() ? 'desabled' : '') ?>>
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-control" name="perfil_usuario" <?php echo (!$this->ion_auth->is_admin() ? 'desabled' : '') ?>>
                                
                                
                                <option value="2" <?php echo ($perfil_usuario->id == 2) ? 'selected' : '' ?>>Contratado</option>
