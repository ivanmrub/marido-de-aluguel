                        ...
                        <tbody>
                            <?php foreach ($usuarios as $user): ?>
                                <tr>
                                    ...
                                    <td><?php echo ($this->ion_auth->is_admin($user->id) ? 'Administrador' : 'Contratado'); ?></td>
                                    <td class="text-center pr-4"><?php echo ($user->active == 1 ? '<span class="badge badge-info  btn-sm">Sim</span>' : '<span class="badge badge-warning btn-sm">Nao</span>' ) ?></td>
                                    <td class="text-right">
