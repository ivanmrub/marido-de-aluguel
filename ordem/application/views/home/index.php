                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-info"><?php echo 'R$&nbsp;' . $soma_vendas->venda_valor_total; ?></div>
                            </div>
                            <div class="col-auto">
        ...
        <div class="row">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 22rem;" src="<?php echo base_url('public/img/produtos_vendidos.svg'); ?>" alt="">
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($produtos_mais_vendidos as $produto): ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><?php echo $produto->quantidade_vendidos ?></td>
                                        </tr>
            ...
            <div class="col-lg-6 mb-4">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 12rem;" src="<?php echo base_url('public/img/servicos_vendidos.svg'); ?>" alt="">
                        </div>
