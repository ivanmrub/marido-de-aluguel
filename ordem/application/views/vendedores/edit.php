        ...
        <div class="card shadow mb-4">   
            ...
            <div class="card-body">
                ...
                <form class="user" method="POST" name="form_edit">
                    ...
                    <p><strong><i class="fas fa-clock"></i>&nbsp;&nbsp;Última alteração:&nbsp;&nbsp</strong><?php echo formata_data_banco_com_hora($vendedor->vendedor_data_alteracao); ?></p>
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row"> 
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control form-control-user " name="vendedor_complemento" placeholder="" value="<?php echo $vendedor->vendedor_complemento; ?>">
                        ...
                        <div class="form-group row"> 
                            ...
                            <div class="col-md-2">
                                <label>CEP</label>
                                <input type="text" class="form-control form-control-user cep" name="vendedor_cep" placeholder="" value="<?php echo $vendedor->vendedor_cep; ?>">
