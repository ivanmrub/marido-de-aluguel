    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a title="Cadastrar novo vendedor" href="<?php echo base_url('vendedores/add'); ?>" class="btn btn-success btn-sm float-right"><i class="fas fa-plus">&nbsp;&nbsp;Novo</i></a>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            <?php foreach ($vendedores as $vendedor): ?>
                                <tr>
                                    ...
                                    <td class="text-center pr-4"><?php echo ($vendedor->vendedor_ativo == 1 ? '<span class="badge badge-info  btn-sm">Sim</span>' : '<span class="badge badge-warning btn-sm">Nao</span>' ) ?></td>
                                    <td class="text-right">
