        ...
        <div class="card shadow mb-4">   
            ...
            <div class="card-body">
                ...
                <form class="user" method="POST" name="form_edit">
                    ...
                    <p><strong><i class="fas fa-clock"></i>&nbsp;&nbsp;Última alteração:&nbsp;&nbsp</strong><?php echo formata_data_banco_com_hora($fornecedor->fornecedor_data_alteracao); ?></p>
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control form-control-user" name="fornecedor_contato" placeholder="Nome do vendedor" value="<?php echo $fornecedor->fornecedor_contato; ?>">
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row"> 
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control form-control-user " name="fornecedor_complemento" placeholder="" value="<?php echo $fornecedor->fornecedor_complemento; ?>">
                        ...
                        <div class="form-group row"> 
                            ...
                            <div class="col-md-2">
                                <label>CEP</label>
                                <input type="text" class="form-control form-control-user cep" name="fornecedor_cep" placeholder="" value="<?php echo $fornecedor->fornecedor_cep; ?>">
