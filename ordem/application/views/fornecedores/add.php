                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row"> 
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control form-control-user " name="fornecedor_complemento" placeholder="" value="<?php echo set_value('fornecedor_complemento'); ?>">
                        ...
                        <div class="form-group row"> 
                            ...
                            <div class="col-md-2">
                                <label>CEP</label>
                                <input type="text" class="form-control form-control-user cep" name="fornecedor_cep" placeholder="" value="<?php echo set_value('fornecedor_cep'); ?>">
