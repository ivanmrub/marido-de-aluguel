      ...
      <div id="content">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a title="Cadastrar novo fornecedor" href="<?php echo base_url('fornecedores/add'); ?>" class="btn btn-success btn-sm float-right"><i class="fas fa-user-tag">&nbsp;Novo</i></a>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            <?php foreach ($fornecedores as $fornecedor): ?>
                                <tr>
                                    ...
                                    <td class="text-center pr-4"><?php echo ($fornecedor->fornecedor_ativo == 1 ? '<span class="badge badge-info  btn-sm">Sim</span>' : '<span class="badge badge-warning btn-sm">Nao</span>' ) ?></td>
                                    <td class="text-right">
