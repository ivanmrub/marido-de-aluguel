                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control form-control-user money" name="produto_preco_custo" placeholder="Preço de custo" value="<?php echo set_value('produto_unidade'); ?>">
