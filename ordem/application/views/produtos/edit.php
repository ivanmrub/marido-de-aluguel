        ...
        <div class="card shadow mb-4">   
            ...
            <div class="card-body">
                ...
                <form class="user" method="POST" name="form_edit">
                    ...
                    <p><strong><i class="fas fa-clock"></i>&nbsp;&nbsp;Última alteração:&nbsp;&nbsp</strong><?php echo formata_data_banco_com_hora($produto->produto_data_alteracao); ?></p>

                    <fieldset class="mt-4 border p-2">

                        <legend class="font-small"><i class="fas fa-tools"></i>&nbsp;Dados principais</legend>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <select class="custom-select" name="produto_ativo"> 
                                    <option value="0" <?php echo ($produto->produto_ativo == 0 ? 'selected' : '') ?>>Nao</option>
