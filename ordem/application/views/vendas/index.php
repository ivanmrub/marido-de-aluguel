    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a title="Cadastrar nova venda" href="<?php echo base_url('vendas/add'); ?>" class="btn btn-success btn-sm float-right"><i class="fas fa-shopping-cart">&nbsp;&nbsp;Nova</i></a>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            <?php foreach ($vendas as $venda): ?>
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a title="Imprimir" href="<?php echo base_url('vendas/pdf/' . $venda->venda_id); ?>" class="btn btn-sm btn-dark"><i class="fas fa-file-pdf"></i></a>
