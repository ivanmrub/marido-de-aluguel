    ...
    <?php $this->load->view('layout/sidebar');  ?>
      ...
      <div id="content">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo base_url('clientes'); ?>">Contratantes</a></li>
          ...
          <div class="card shadow mb-4">   
            ...
            <div class="card-body">
                ...
                <form class="user" method="POST" name="form_edit">
                    ...
                    <p><strong><i class="fas fa-clock"></i>&nbsp;&nbsp;Última alteração:&nbsp;&nbsp</strong><?php echo formata_data_banco_com_hora($cliente->cliente_data_alteracao); ?></p>
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row"> 
                            <div class="col-md-2">
                                ...
                                <input type="text" class="form-control form-control-user sp_celphones" name="cliente_telefone" placeholder="Telefone fixo do cliente" value="<?php echo $cliente->cliente_telefone; ?>">
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row"> 
                            ...
                            <div class="col-md-3">
                                <label>CEP</label>
                                <input type="text" class="form-control form-control-user cep" name="cliente_cep" placeholder="" value="<?php echo $cliente->cliente_cep; ?>">
                        ...
                        <div class="form-group row"> 
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control form-control-user " name="cliente_complemento" placeholder="" value="<?php echo $cliente->cliente_complemento; ?>">
