                ...
                <form class="user" method="POST" name="form_add">
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row"> 
                            <div class="col-md-2">
                                ...
                                <input type="text" class="form-control form-control-user sp_celphones" name="cliente_telefone" placeholder="Telefone fixo do cliente" value="<?php echo set_value('cliente_telefone'); ?>">
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row"> 
                            ...
                            <div class="col-md-3">
                                <label>CEP</label>
                                <input type="text" class="form-control form-control-user cep" name="cliente_cep" placeholder="" value="<?php echo set_value('cliente_cep'); ?>">
                        ...
                        <div class="form-group row"> 
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control form-control-user " name="cliente_complemento" placeholder="" value="<?php echo set_value('cliente_complemento'); ?>">
