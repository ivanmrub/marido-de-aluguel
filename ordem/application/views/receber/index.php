    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a title="Cadastrar nova conta" href="<?php echo base_url('receber/add'); ?>" class="btn btn-success btn-sm float-right"><i class="fas fa-tools">&nbsp;&nbsp;Nova</i></a>
            </div>
            <div class="card-body">
                            ...
                            <div class="modal fade" id="conta-<?php echo $conta->conta_receber_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">Deseja excluir a conta ?</div>
