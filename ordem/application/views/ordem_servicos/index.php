    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a title="Cadastrar nova ordem de serviço" href="<?php echo base_url('os/add'); ?>" class="btn btn-success btn-sm float-right"><i class="fas fa-shopping-basket">&nbsp;&nbsp;Nova</i></a>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            <?php foreach ($ordens_servicos as $os): ?>
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a title="Imprimir" href="<?php echo base_url('os/pdf/' . $os->ordem_servico_id); ?>" class="btn btn-sm btn-dark"><i class="fas fa-file-pdf"></i></a>
