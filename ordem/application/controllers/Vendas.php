...
class Vendas extends CI_Controller {
    ...
    public function edit($venda_id = NULL) {
        ...
        if (!$venda_id || !$this->core_model->get_by_id('vendas', array('venda_id' => $venda_id))) { //ordens errado -> ordem_
    ...
    public function pdf($venda_id = NULL) {
        ...
        if (!$venda_id || !$this->core_model->get_by_id('vendas', array('venda_id' => $venda_id))) { 
            ...
            $html .= '<p align="right" style="font-size: 15px">Venda Nº&nbsp;' . $venda->venda_id . '</p>';

            $html .= '<p>'
                    . '<strong>Contratante: </strong>' . $venda->cliente_nome . '<br/>'
 ...
 //           $venda_id = $venda->venda_id;
            ...
            $html .= '<td style="border-top: solid #dd 1px">' . $valor_final_venda->venda_valor_total . '</td>';
