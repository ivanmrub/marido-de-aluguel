...
class Usuarios extends CI_Controller {
    ...
    public function add() {
        ...
        $this->form_validation->set_rules('password', 'Senha', 'required|min_length[5]|max_length[100]');
    ...
    public function edit($usuario_id = NULL) {
        ...
        if (!$usuario_id || !$this->ion_auth->user($usuario_id)->row()) {
            ...
            $this->form_validation->set_rules('password', 'Senha', 'min_length[5]|max_length[100]');
            $this->form_validation->set_rules('confirm_password', 'Confirma', 'matches[password]');
